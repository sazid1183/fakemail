...
<?php 
    ...
    $sql_adan = "SELECT * FROM `{$session_email}` ORDER BY `{$session_email}`.`mail_id` DESC LIMIT {$offset}, {$limit}";
...
?>
    <div class="my-3 col-11 d-block mx-auto"><p class="h4 text-primary">Hi <?php echo $session_name;?>. Check your mail.</p></div>
     <div class="allmail">
...
<?php
    $query_pagination = "SELECT * FROM `{$session_email}`";
...
<form action="home" method="post" class="d-md-inline d-none">
...
<form action="home" method="post" class="d-md-none d-inline">
